...
export default function PostCard({
    ...
    return (
        <Link href={`/posts/${slug}`} className="group -m-2 block w-full rounded-2xl p-2 transition duration-300 hover:-translate-y-1 hover:bg-white/5">
            <article className="overflow-hidden">
                <Image
                    ...
                    width={467}
                    height={264}
                    className="aspect-[467/264] h-auto w-full rounded-xl border border-white/15 bg-neutral-700 object-cover opacity-50 transition duration-300 group-hover:border-white/25 group-hover:opacity-80"
                />
